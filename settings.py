...
# magic
magic_data = {
	'flame': {'strength': 5,'cost': 20,'graphic':resource_path('graphics/particles/flame/fire.png')},
	'heal' : {'strength': 20,'cost': 10,'graphic':resource_path('graphics/particles/heal/heal.png')}
}

# enemy
monster_data = {
	'squid': {'health': 100,'exp':100,'damage':20,'attack_type': 'slash', 'attack_sound':resource_path('audio/attack/slash.wav'), 'speed': 3, 'resistance': 3, 'attack_radius': 80, 'notice_radius': 360},
	'raccoon': {'health': 300,'exp':250,'damage':40,'attack_type': 'claw',  'attack_sound':resource_path('audio/attack/claw.wav'),'speed': 2, 'resistance': 3, 'attack_radius': 120, 'notice_radius': 400},
