...
> *Add a GIF or screenshot of your game in action here!*  
...
│   ├── level.py        # Level creation and sprite management
│   ├── player.py       # Player movement, stats, and actions
│   ├── enemy.py        # Enemy AI logic and behavior
│   ├── magic.py        # Magic system logic
│   └── ui.py           # HUD and user interface rendering
│
